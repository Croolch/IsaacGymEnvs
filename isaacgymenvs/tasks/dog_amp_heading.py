...
from .dog_amp_task_base import DogAMPTask

TAR_ACTOR_ID = 1
TAR_FACING_ACTOR_ID = 2

class DogAMPHeading(DogAMPTask):
    ...
    def pre_physics_step(self, actions):
        ...
        self._prev_root_pos[:] = self._dog_root_states[..., 0:3]
        return
    ...
    def _draw_task(self):
        ...
        root_pos = self._dog_root_states[..., 0:3]
    ...
    def _update_marker(self):
        humanoid_root_pos = self._dog_root_states[..., 0:3]
    ...
    def _compute_reward(self, actions):
        root_pos = self._dog_root_states[..., 0:3]
        root_rot = self._dog_root_states[..., 3:7]
...
def compute_heading_observations(root_states, tar_dir, tar_speed, tar_face_dir):
    ...
    heading_rot = torch_jit_utils.calc_heading_quat_inv(root_rot)
...
def compute_heading_reward(root_pos, prev_root_pos, root_rot, tar_dir, tar_speed, tar_face_dir, dt):
    ...
    heading_rot = torch_jit_utils.calc_heading_quat(root_rot)
